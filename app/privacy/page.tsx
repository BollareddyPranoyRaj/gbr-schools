  ...
  return (
    <div className="min-h-screen bg-background pt-16 sm:pt-20 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-text-muted">
        <section>
          <h2 className="text-lg font-semibold text-text-main mb-3">1. Introduction</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-text-main mb-3">2. Information We Collect</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-text-main mb-3">3. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-text-main mb-3">4. Data Sharing and Security</h2>
          <p>
