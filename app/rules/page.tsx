  ...
  return (
    <main className="min-h-screen bg-background pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-primary mb-4">School Rules & Guidelines</h1>
      ...
      <div className="space-y-12">
        <section className="bg-[var(--color-surface)] border border-gray-200 rounded-xl p-8 shadow-sm">
          <h2 className="text-2xl font-semibold text-primary mb-4 border-b border-gray-200 pb-2">General Rules</h2>
        ...
        <section className="bg-[var(--color-surface)] border border-gray-200 rounded-xl p-8 shadow-sm">
          <h2 className="text-2xl font-semibold text-primary mb-4 border-b border-gray-200 pb-2">School Uniform</h2>
          <ul className="list-disc list-inside text-text-muted space-y-3 text-sm leading-relaxed">
        ...
        <section className="bg-[var(--color-surface)] border border-gray-200 rounded-xl p-8 shadow-sm">
          <h2 className="text-2xl font-semibold text-primary mb-4 border-b border-gray-200 pb-2">Transport Rules</h2>
          <ul className="list-disc list-inside text-text-muted space-y-3 text-sm leading-relaxed">
