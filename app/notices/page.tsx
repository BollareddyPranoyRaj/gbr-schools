  ...
  return (
    <div className="min-h-[80vh] bg-background flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-lg mx-auto">
        <h1 className="text-3xl font-bold text-primary mb-3">Notice Board</h1>
        <p className="text-text-muted mb-8 text-sm leading-relaxed">
          This page is under development. Important circulars, news, and the academic calendar will appear here soon.
        </p>
        <Link 
          href="/"
